...
> | --- | --- | --- |
> | Betygsrapportering | Saknar punktlista | Betyg skrivet utan punktlista: Som betygsskala används U–VG. För VG på kursen krävs VG på minst fyra av delkurserna. Betygsrapportering: Moment 1: Fler… |
> | Examinationsformer | Saknar punktlista | Examinationsformer skrivet som löpande text: Delkurserna examineras genom fortlöpande bedömning av aktivt deltagande i seminarier, genom skrifliga och muntliga uppgi… |
> | Introfras | Prosa/rubrik före frasning | Lärandemål inleds inte med 'Efter ...': Målet med kursen är att den studerande utvecklar sina ämneskunskaper och ämnesdidaktiska kunskaper inom Svenska som andr… |
> | Omfång på lärandemål | För många mål | 26 lärandemål (maximum rekommenderat: 15 för 45 hp) |
> | Omfång på lärandemål | Långt mål | 30 ord: - visa insikt i att uttalet förutom att signalera ett visst förstaspråk även kan… |
> | Omfång på lärandemål | Långt mål | 26 ord: - planera undervisning för att främja elevernas utveckling av strategier för läs… |
> | Samstämmighet svenska och engelska | Paritetsskillnad | Svenska: 26 mål, engelska: 0 mål (diff 26) |
> | Övrigt | Saknar standardfras om pedagogiskt stöd | Saknar standardfras om pedagogiskt stöd: Denna utbildning är en uppdragsutbildning och får endast sökas av lärare som deltar i lärarfortbildningen enligt **Föror… |
<!-- analys:end -->

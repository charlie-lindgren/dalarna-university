...
cssclasses: [vilande]
scrape_hash: 3ae34a1752764f24
url: https://www.du.se/sv/utbildning/kurser/kursplan/?code=SS2009
...
> | --- | --- | --- |
> | Betygsrapportering | Saknar punktlista | Betyg skrivet utan punktlista: Som betygsskala används U–VG. För vg på hela kursen krävs vg i båda delkurserna.… |
> | Examinationsformer | Saknar punktlista | Examinationsformer skrivet som löpande text: I samtliga delkurser utgör aktivt deltagande i seminarier en del av examinationen. De enskilda delkurserna examineras de… |
> | Introfras | Prosa/rubrik före frasning | Lärandemål inleds inte med 'Efter ...': Se respektive delkurs… |
...
> | Stavfel och språkbruk | Felstavning | `inlärartal` (sv) |
> | Stavfel och språkbruk | Felstavning (en) | `affrican` (en) |
> | Stavfel och språkbruk | Felstavning (en) | `centrual` (en) |
> | Stavfel och språkbruk | Felstavning (en) | `dealrs` (en) |
> | Stavfel och språkbruk | Felstavning (en) | `dourse` (en) |
> | Stavfel och språkbruk | Felstavning (en) | `egarding` (en) |
> | Stavfel och språkbruk | Felstavning (en) | `prespectives` (en) |
> | Stavfel och språkbruk | Felstavning (en) | `relatec` (en) |
> | Stavfel och språkbruk | Felstavning (en) | `researchj` (en) |
> | Stavfel och språkbruk | Felstavning (en) | `teorritoriality` (en) |
...
[Kursplan på du.se →](https://www.du.se/sv/utbildning/kurser/kursplan/?code=SS2009)

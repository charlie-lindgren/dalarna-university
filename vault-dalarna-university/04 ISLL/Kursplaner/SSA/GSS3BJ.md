---
kurskod: GSS3BJ
kursnamn: "Grundläggande svenska som andraspråk III (nivå CEFR B1.1)"
course_name: "Basic Swedish as a Second Language III (level CEFR B1.1)"
...
scrape_hash: 452b6ed11704ee78
url: https://www.du.se/sv/utbildning/kurser/kursplan/?code=GSS3BJ
up: "[[Svenska som andraspråk]]"
---

# GSS3BJ

[Kursplan på du.se →](https://www.du.se/sv/utbildning/kurser/kursplan/?code=GSS3BJ)

**Kursnamn:** Grundläggande svenska som andraspråk III (nivå CEFR B1.1)
**Course Name:** Basic Swedish as a Second Language III (level CEFR B1.1)
...
Efter godkänd kurs ska studenten kunna:
  ...
  - tillämpa fördjupade kunskaper om svenska språkets grammatik och ordförråd i tal och skrift

  - förstå och analysera texter av olika slag, däribland ett skönlitterärt verk

  - med gott uttal, uttrycka sig i olika samtalssituationer och lösa kommunikationsproblem som uppkommer i samtal

  - författa olika typer av texter på svenska samt reflektera över och utveckla dessa

  - redogöra för kunskaper om svensk kultur och svenskt samhälle.

## Innehåll

Kursen har en kommunikativ och viss språkvetenskaplig inriktning. Under kursen sker ett fördjupat arbete med svenska språkets grammatik, ordförråd och uttal. Varierande typer av texter, inklusive ett skönlitterärt verk, läses och analyseras. Teman om svensk kultur och samhällsliv behandlas och jämförelser görs med andra för studenterna bekanta kulturer och samhällen. Genom produktiva och perceptiva uppgifter samt interaktiva klassrumsaktiviteter övar den studerande sina grammatiska färdigheter och sin förmåga att lösa problem i olika typer av samtalssituationer samt i sitt skrivande på svenska.
...
För att få betyget Väl Godkänd på hela kursen krävs Väl Godkänd på båda modulerna.
...
- Grundläggande svenska som andraspråk II (nivå CEFR A2.2), 7,5 hp

## Övrigt

Denna kurs överlappar kursen _Nybörjarsvenska för internationella studenter III_, 7,5 hp.

...
Efter godkänd kurs ska studenten kunna:
  ...
  - kommunicera obehindrat på kinesiska kring olika ämnen

  - läsa och förstå kortare autentiska kinesiska texter

  - skriva korta uppsatser på kinesiska om olika ämnen samt kunna ge argument till stöd för sina åsikter

  - använda ett utvecklat ordförråd inklusive några av de vanligaste idiomatiska uttrycken

  - använda en relativt komplicerad meningsbyggnad.

## Innehåll

Kursen omfattar sex delmoment som bygger på varandra. De fyra färdigheterna lyssna, tala, läsa och skriva integreras i mycket hög grad med varandra. Under kursen tränar studenterna förmågan att behärska varierande språkstilar som hör till olika genrer samt att debattera och presentera olika välkända teman på kinesiska. I kursen ingår även analys av valda autentiska kinesiska texter och skrivuppgifter där studenterna tillämpar sina kunskaper om kinesisk grammatik, språkstruktur och idiomatiska uttryck.
...
För att få betyget VG på hela kursen krävs VG på minst 9 hp, inklusive modulerna _Skriftlig examination_ och _Muntlig examination_.

Betyg rapporteras enligt följande:

  - Muntlig och skriftlig språkfärdighet, del 1 - 3 hp | U–VG
  - Muntlig och skriftlig språkfärdighet, del 2 - 3 hp | U–VG
  - Muntlig och skriftlig språkfärdighet, del 3 - 3 hp | U–VG
  - Muntlig och skriftlig språkfärdighet, del 4 - 3 hp | U–VG
  - Skriftlig tentamen - 1,5 hp | U–VG
  - Muntlig tentamen - 1,5 hp | U–VG

## Förkunskapskrav

- 90 hp inom huvudområdet kinesiska, inklusive kursen Kinesiska i tal och skrift III, 15 hp

## Övrigt

Kinesiska används som undervisningsspråk, med stöd av svenska eller engelska.

Kursen överlappar tidigare kurskod KI1030.
...
For a final course grade of VG (Pass with Credit), students must achieve VG for at least 9 credits, including the modules _Written examination_ and _Oral examination_.

...
course_name: "Spanish: Basic Course"
hp: 15 högskolepoäng
niva: "Grundnivå"
...
Efter godkänd kurs ska studenten kunna:
  ...
  - interagera muntligt och skriftligt i både förberedda och spontana situationer på spanska

  - visa grundläggande kunskaper i det spanska språkets grammatiska strukturer och tillämpa dessa i muntliga och skriftliga uppgifter

  - analysera skillnader mellan det svenska och det spanska språket gällande i synnerhet uttal och grammatik

  - diskutera vissa aspekter av kultur och samhällsliv i den spansktalande världen.

## Innehåll

Kursen syftar till att utveckla grundläggande kunskaper i spanska språket och därigenom förbereda den studerande för vidare högskolestudier i spanska. Kursen omfattar textläsning, arbete med uttal och ordförråd, hörövningar och varierande muntliga och skriftliga övningar. Basfärdighet i spansk grammatik tillämpas i grammatiska analyser och i kontrastiva övningar. Kursen introducerar studenterna till vissa aspekter av kultur och samhälle i den spansktalande världen.
...
- Aktivt deltagande i seminarier
  ...
  - Nätbaserade skriftliga prov

  - Skriftlig online-tentamen

## Betyg

Som betygsskala på hel kurs används U–VG.

För att få betyget VG på hela kursen krävs VG på modulerna _Muntlig presentation_, _Skriftlig inlämningsuppgift_ samt _Tentamen online_.

Betyg rapporteras enligt följande:

  - Språkfärdighet 1 - 1 hp | U–VG
  - Språkfärdighet 2 - 1 hp | U–VG
  - Språkfärdighet 3 - 1 hp | U–VG
  - Språkfärdighet 4 - 1 hp | U–VG
  - Språkfärdighet 5 - 1 hp | U–VG
  - Språkfärdighet 6 - 1 hp | U–VG
  - Muntlig presentation - 2 hp | U–VG
...
To achieve the grade of VG for the whole course, students require a VG in the modules _Oral presentation_, _Written assignment,_ and _Online examination_.

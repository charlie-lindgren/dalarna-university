---
kurskod: GPR3GP
kursnamn: "Portugisiska II"
course_name: "Portuguese II"
hp: 30 högskolepoäng
niva: "Grundnivå"
...
[Kursplan på du.se →](https://www.du.se/sv/utbildning/kurser/kursplan/?code=GPR3GP)

**Kursnamn:** Portugisiska II
**Course Name:** Portuguese II

- **Poäng:** 30 högskolepoäng
- **Nivå:** Grundnivå
- **Kursen kan ingå i följande huvudområde(n):** Portugisiska 1
- **Ämnestillhörighet:** Portugisiska (PRA)
- **Fastställd:** Fastställd 2025-06-25 . Kursplanen gäller fr.o.m. 2025-06-25.
...
1.Grammatik och skriftlig språkfärdighet II, 7,5 högskolepoäng

Efter avslutad delkurs ska studenten kunna:

  - tillämpa en korrekt språkstruktur samt ett adekvat språkbruk  
(vokabulär och idiomatiska uttryck) i egen textproduktion inom olika genrer

  - diskutera de specifika drag som utmärker olika skriftliga genrer
...
2.Muntlig språkfärdighet II, 7,5 högskolepoäng

Efter avslutad delkurs ska studenten kunna:

  - visa insikt i det portugisiska språkets fonetik och fonologi genom att uttala  

  - analysera och redogöra för innehållet i talad portugisiska, inom olika genrer och från olika språkvarieteter

  - tillämpa ett varierat och adekvat språkbruk anpassat till genren, såsom vokabulär, informellt eller formellt tal.

3.Det nutida Portugal: Litteratur och samhälle, 7,5 högskolepoäng
...
4.Introduktion till studier av samtida litteratur på portugisiska, 7,5 högskolepoäng

Efter avslutad delkurs ska studenten kunna:

  - diskutera litterär form och innehåll i ett urval av samtida portugisiskspråkig  
litteratur från olika världsdelar
  ...
  - redogöra för ett urval litteraturvetenskapliga perspektiv, begrepp och metoder för litterära analyser

  - presentera litterära analyser på portugisiska.
...
Delkursen omfattar en fördjupning i studierna av det portugisiska språkets språkstruktur och språkbruk. Fokus läggs på övningar i textproduktion av olika genrer. Vidare innehåller kursen översättning av enklare texter till och från portugisiska. Skillnader och likheter mellan olika varieteter av portugisiska berörs och problematiseras utifrån begrepp såsom språksyn, normer och språklig variation.

2.Muntlig språkfärdighet II, 7,5 högskolepoäng

Delkursen omfattar en fördjupning i studierna av uttal och muntlig språkfärdighet. Fokus läggs på övningar i hörförståelse och muntliga framställningar under interaktiva former.

3.Det nutida Portugal: Litteratur och samhälle, 7,5 högskolepoäng

Delkursen innehåller studier av skönlitterära texter, filmatiseringar, sakprosa och annat samtidsmaterial som belyser Portugals samhällsutveckling från början av 1900-talet till idag. Fokus ligger på ett närstudium av ett urval representativa skönlitterära texter, vars innehåll sätts i relation till historiska och sociopolitiska företeelser såsom monarki, republik, kolonialmakt, diktatur, demokrati och medlemskap i EU. Kursen diskuterar även samhällsutvecklingen utifrån ett antal postkoloniala och genusteoretiska frågeställningar.

4.Introduktion till studier av samtida litteratur på portugisiska, 7,5 högskolepoäng

Delkursen innehåller studier av samtida litterär text på portugisiska från olika världsdelar. Texternas litterära form och innehåll studeras och diskuteras muntligt och skriftligt utifrån den estetiska, historiska och sociokulturella kontext där texterna producerats. På kursen introduceras ett urval litterära teoretiska perspektiv, grundläggande terminologi och metoder som tillämpas i litterära analyser.
...
- Aktivt deltagande i seminarier
  ...
  - Granskning av medstudenters skriftliga uppgifter
...
Betyg rapporteras enligt följande:
  ...
  - Skriftlig översättning - 3 hp | U–VG
  - Skriftliga inlämningsuppgifter med fokus på grammatik - 4,5 hp | U–VG
  - Uttal och uttalsprov - 3 hp | U–VG
  - Muntliga redovisningar - 4,5 hp | U–VG
  - Det nutida Portugal: Litteratur och samhälle - 7,5 hp | U–VG
...
Kursen överlappar kurserna _Det nutida Portugal: Litteratur och samhälle_, 7,5 hp, _Portugisiska: Introduktion till studier av samtida litteratur på portugisiska_, 7,5 hp, _Portugisiska: Muntlig språkfärdighet II_, 7,5 hp och _Portugisiska: Grammatik och skriftlig språkfärdighet II_, 7,5 hp.
...
1.Grammar and Written Language Proficiency II, 7.5 Credits
...
2.Oral Language Proficiency II, 7.5 Credits
...
3.Contemporary Portugal: Literature and Society, 7.5 Credits
...
4.Introduction to the Study of Contemporary Literature in Portuguese, 7.5 Credits

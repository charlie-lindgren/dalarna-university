...
course_name: "French IV: French Literary Criticism"
...
> | Examinationsformer | Saknar punktlista | Examinationsformer skrivet som löpande text: Kursen examineras genom skriftliga inlämningsuppgifter och aktivt deltagande i seminarier.… |
> | Frasningskonsistens | Avviker från referensformen | Efter avslutad kurs ska den studerande kunna:… |
> | Övrigt | Saknar standardfras om pedagogiskt stöd | Saknar standardfras om pedagogiskt stöd: Ersätter AFR24Y.… |
<!-- analys:end -->
...
Upon completion of the course, students will be able to:
  ...
  - critically comment in French on literary works from different periods and on different interpretations of those texts 
  - describe the dominant tendencies of literary theory from the 1900s and 2000s, and use the theoretical concepts in the analysis of literary texts 
  - apply literary methodology in an independent way in written literary analysis of literary works in French 
  - argue orally and convincingly in academic French for their analyses.

### Course Content

The course includes advanced studies in literary theory and method as based on French literature. In the course, French literary texts are critically analysed, and the course allows for a deeper understanding of literary theories. Literary theories and methods will be applied in literary analyses.

### Assessment

The course is examined through written assignments and active participation in seminars.

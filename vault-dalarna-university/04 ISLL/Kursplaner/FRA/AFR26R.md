...
course_name: "French IV: Linguistics with a Focus on Language Learning"
...
> | Examinationsformer | Saknar punktlista | Examinationsformer skrivet som löpande text: Kursen examineras dels genom skriftliga och muntliga inlämningsuppgifter och aktivt deltagande vid seminarier, dels geno… |
...
On completion of the course, students will be able to:
  ...
  - reflect on research literature in French within an area of linguistics with a focus on the learning of a foreign language, and will also be able to make use of various language learning theories

  - formulate, evaluate and discuss different issues within language learning

  - analyse a corpus or sequences from different corpora with a focus om language learning

  - explain in academic French, in both written and oral form, the latest research in language learning in a coherent and methodologically and terminologically customary manner.

### Course Content

The course looks at linguistics with a focus on learning a foreign language based on different texts, corpora and scientific works. In consultation with the teacher, students select a subject to specialise in.

### Assessment

Students are assessed by way of written and oral assignments, active participation in seminars and a short linguistic analysis that they present in oral and written form.

### Forms of Study

Obligatory seminars. The language of instruction is French.

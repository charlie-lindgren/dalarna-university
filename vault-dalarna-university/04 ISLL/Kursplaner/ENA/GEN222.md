...
cssclasses: [vilande]
scrape_hash: e238d15bce3b200a
url: https://www.du.se/sv/utbildning/kurser/kursplan/?code=GEN222
up: "[[Engelska]]"
---
...
> | --- | --- | --- |
> | Betygsrapportering | Saknar punktlista | Betyg skrivet utan punktlista: Som betygsskala används U–G. Betygsrapportering: Moment 1: Engelskspråkig ungdomslitteratur - 7,5 hp Moment 2: Teman i s… |
> | Examinationsformer | Saknar punktlista | Examinationsformer skrivet som löpande text: I delkurs 1 sker examination genom kontinuerlig bedömning av den studerandes muntliga framställningar och aktiva seminar… |
> | Introfras | Prosa/rubrik före frasning | Lärandemål inleds inte med 'Efter ...': Kursens övergripande mål är att den studerande… |
> | Omfång på lärandemål | För många mål | 31 lärandemål (maximum rekommenderat: 15 för 45 hp) |
> | Omfång på lärandemål | Långt mål | 33 ord: - visa fördjupad förståelse för elevers syn på och upplevelser av sitt språklära… |
> | Omfång på lärandemål | Långt mål | 29 ord: - redogöra för olika former av informations- och digitala hjälpmedel för att utv… |
...
[Kursplan på du.se →](https://www.du.se/sv/utbildning/kurser/kursplan/?code=GEN222)

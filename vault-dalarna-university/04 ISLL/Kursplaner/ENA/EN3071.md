...
cssclasses: [vilande]
scrape_hash: b2bbf4a14aa82fd9
url: https://www.du.se/sv/utbildning/kurser/kursplan/?code=EN3071
up: "[[Engelska]]"
---
...
> | Examinationsformer | Saknar punktlista | Examinationsformer skrivet som löpande text: Delkurs 1: Examination sker genom fortlöpande bedömning av skriftliga arbeten och seminarieaktiviteten. Delkurs 2: Kurse… |
> | Introfras | Prosa/rubrik före frasning | Lärandemål inleds inte med 'Efter ...': Kursen vänder sig till lärarstuderande och bygger på kursen _Engelska IIl, inklusive examensarbete 1 för ämneslärarexame… |
> | Omfång på lärandemål | För många mål | 20 lärandemål (maximum rekommenderat: 12 för 30 hp) |
> | Omfång på lärandemål | Långt mål | 27 ord: - diskutera olika sätt på vilka situationella faktorer kan påverka diskursen och… |
> | Omfång på lärandemål | Långt mål | 31 ord: - identifiera vilka de karakteristiska egenskaperna är hos olika typer av text, … |
> | Omfång på lärandemål | Långt mål | 28 ord: - genomföra ett begränsat forskningsprojekt baserat på en liten samling med aute… |
...
[Kursplan på du.se →](https://www.du.se/sv/utbildning/kurser/kursplan/?code=EN3071)

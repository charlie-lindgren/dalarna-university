...
course_name: "Introduction to Intercultural Literature Studies"
...
> | --- | --- | --- |
> | Bloom-taxonomi | Låg verbnivå för avancerad kurs | Avancerad kurs utan analysera/värdera/skapa-verb; fördelning [1,3,1,0,0,0] |
<!-- analys:end -->

# AEN2CT

[Kursplan på du.se →](https://www.du.se/sv/utbildning/kurser/kursplan/?code=AEN2CT)
...
- **Fastställd:** Fastställd 2026-06-16 . Kursplanen gäller fr.o.m. 2026-07-29.
...
I kursen introduceras termer och begrepp använda inom forskning om  
kulturmöten. Ett urval relevanta teoribildningar inom interkulturella litteraturstudier utforskas och tillämpas på relevanta litterära verk.
...
Betyg rapporteras enligt följande:
  ...
  - Introduktion till interkulturella litteraturstudier - 7,5 hp | A–F
...
Kursen överlappar tidigare kurskod AJP23N.

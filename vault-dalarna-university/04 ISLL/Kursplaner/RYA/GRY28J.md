...
course_name: "Russian II: Grammar and Written Language Proficiency"
hp: 10 högskolepoäng
niva: "Grundnivå"
huvudomrade: "Ryska 1"
amne: "Ryska"
...
> | Examinationsformer | Saknar punktlista | Examinationsformer skrivet som löpande text: Examination sker i form av skriftliga inlämningsuppgifter, bedömning av aktivt deltagande i seminarier och en avslutande… |
...
> | Övrigt | Saknar standardfras om pedagogiskt stöd | Saknar standardfras om pedagogiskt stöd: Ersätter RY1028.… |
<!-- analys:end -->
...
On completion of the course, students shall be able to:
  ...
  - use basic grammatical concepts, and analyse and explain the grammatical structure of sentences and simple texts

  - demonstrate basic knowledge of word formation in Russian by practically applying relevant word formation rules

  - describe and apply Russian aspect doctrine

  - explain Russian cases based on their semantic and syntactic features, and identify and use commonly occurring patterns of conjugation

  - write short texts on everyday topics in Russian and translate simple texts from Swedish/English to Russian.

### Course Content

The course gives in-depth knowledge of basic Russian grammar. In the course, students practice the ability to master and analyse the linguistic structure of Russian through practical exercises in word formation, case studies and verb aspect.

### Assessment

Written assignments, assessment of active participation in seminars and a final written examination.

### Forms of Study

The language of instruction is Swedish and/or English as well as Russian. Teaching takes place in obligatory seminars.

### Grades

The Swedish grades U–VG.

To achieve the grade of VG for the whole course, students must achiev VG in both modules.

...
[Kursplan på du.se →](https://www.du.se/sv/utbildning/kurser/kursplan/?code=GTY3CU)
...
- **Fastställd:** Fastställd 2024-11-13 . Kursplanen gäller fr.o.m. 2024-11-13.
...
1.Muntlig språkfärdighet och kulturkunskap II, 6 högskolepoäng
...
Efter godkänd delkurs ska den studerande kunna:
  ...
  - redogöra för de tyskspråkiga ländernas moderna historia och diskutera aktuella samhällsyttringar

  - reflektera över kulturrelevanta begrepp.

2.Skriftlig språkfärdighet II, 6 högskolepoäng
...
3.Språk- och kulturhistoria med akademiskt skrivande, 6 högskolepoäng
...
4.Tyskspråkig litteratur och litteraturhistoria, 6 högskolepoäng
...
7.Språkdidaktik 2A, 6 högskolepoäng
...
8.Språkdidaktik 2B, 6 högskolepoäng
...
1.Oral Language Proficiency and Cultural Studies II, 6 Credits

On completion of the module, students will be able to:

  - express themselves orally without intrusive grammatical or idiomatic errors and with linguistic variation in terms of content taken from different areas

  - use and adapt the language to different social, interest-related and profession-related contexts
...
2.Written Language Proficiency II, 6 Credits

On completion of the module, students will be able to:

  - present central grammatical concepts and apply these in a critical evaluation of their own and others’ texts

  - use and reflect on contrastive analysis and translation as a didactic method

  - express themselves in writing without intrusive grammatical errors and with some linguistic variation in terms of content taken from different areas

  - reflect contrastively on important stylistic features in different types of texts and discover contrastively important similarities and differences between Swedish and German syntax.

3.Language and Cultural History with Academic Writing, 6 Credits

On completion of the module, students will be able to:

  - describe the structure and history of German and theorise about the development of German
...
4.Literature in German and German Literary History, 6 Credits

On completion of the module, students will be able to:

  - orally and in writing present literary analyses of poetry, drama and prose

  - reflect on the literary history and culture of German-speaking countries and identify relevant issues

  - discuss central literary genres and concepts.

5.Language Learning and Teaching 1A, 6 Credits
...
6.Language Learning and Teaching 1B, 6 Credits
...
7.Language Learning and Teaching 2A, 6 Credits
...
8.Language Learning and Teaching 2B, 6 Credits
...
Module 1. Oral Language Proficiency and Cultural Studies II, 6 credits  
Module 2. Written Language Proficiency II, 6 credits  
Module 3. Language and Cultural History with Academic Writing, 6 credits  
Module 4. Literature in German and German Literary History, 6 credits
...
In this module, great emphasis is placed on the practice of linguistic production. Emphasis is placed on the practice of an active vocabulary. In the module, culture and society of German-speaking countries are discussed using texts central to the module.

2.Written Language Proficiency II, 6 Credits

This module includes an in-depth study of German grammar with a focus on written text production as well as an in-depth study of contrastive analysis and translation as didactic tools. The module consists of two knowledge areas: modern German syntax with subject didactics, and language use in theory and practice. In the syntax area, emphasis is on the theoretical reflection on central grammatical concepts and the analysis of contrastively important differences between German and Swedish. In terms of subject didactics, the focus is primarily on the discussion of the application of contrastive methods for different age groups. In the language use area, students practise their written text production by translating from Swedish to German and they reflect on translation as a didactic tool from a historical perspective.

3.Language and Cultural History with Academic Writing, 6 Credits

This module covers two areas of knowledge, the first of which, language and cultural history, focuses on the main features of language development from Germanic to modern German. Representative texts from each period are studied from a phonetic, syntactic and cultural-historical perspective. In the second area of knowledge, students write a short essay that has a didactic focus on language or literature. They work to improve their academic writing through the writing of the essay.

4.Literature in German and German Literary History, 6 Credits

This module contains an overview of German-language literature from the Enlightenment and later. Students read and analyse representative literary works with respect to time-bound, stylistically typical features. Further, there is discussion on how literature can be applied in teaching.

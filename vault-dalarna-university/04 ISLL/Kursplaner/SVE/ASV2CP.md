...
Efter godkänd kurs ska studenten kunna:
  ...
  - analysera och värdera sambandet mellan elevers språkförståelse, läsförkunskaper, ordavkodning och tidiga skrivutveckling samt hur dessa delar kan följas upp och stödjas i undervisningen ur första- och andraspråksperspektiv

  - planera, genomföra och framåtsiktande analysera undervisning som ur första- och andraspråksperspektiv utvecklar elevers språkförståelse, avkodning, läsförståelse och läsflyt

  - analysera och kritiskt granska hur läsundervisningen kan stödja utvecklingen av alla elevers läsförståelse och bidra till att främja ett långsiktigt intresse för läsning

  - problematisera och diskutera utmaningar i undervisningen i förskoleklass och årskurs 1–3 med fokus på olika metoder för läsinlärning och läsutveckling samt analysera hur utmaningarna kan hanteras.
...
•    Språk-, läs- och skrivdidaktisk fördjupning för undervisning i förskoleklass och årskurs 1–3 utifrån första- och andraspråksperspektiv, 7,5 högskolepoäng| U–G
...
Kursen vänder sig i första hand till lärare verksamma i förskoleklass eller årskurs 1–3 och förutsätter att den studerande kan genomföra vissa moment i den egna verksamheten.

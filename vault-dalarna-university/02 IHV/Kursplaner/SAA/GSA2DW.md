...
cssclasses: [vilande]
scrape_hash: 969ade6e4cd40975
url: https://www.du.se/sv/utbildning/kurser/kursplan/?code=GSA2DW
...
- **Reviderad:** Reviderad 2023-11-30 . Revideringen är giltig fr.o.m. 2023-11-30.
...
Den studerande ska efter avslutad kurs kunna:
  ...
  - visa förmåga att analysera data genom grundläggande statistika analyser. 
...
värdera välfärdspolitiska prioriteringar mellan olika befolkningsgrupper utifrån fakta och statistik gällande levnadsvillkor
  ...
  - reflektera över sambandet mellan enkätkonstruktion och möjligheter till dataanalys gällande försörjning, rehabilitering och aktivering.

## Innehåll

Kursen behandlar teoretiska och praktiska kunskaper i socialpolitik och socialt arbete rörande försörjning, rehabilitering och aktivering på individ-, grupp- och samhällsnivå. I kursen belyses även utvecklingstrender inom arbetslivet och socialtjänsten, samt levnadsvillkor för olika grupper i samhället. Vidare behandlar kursen olika element i kvantitativa metoder, såsom relationen mellan en forskningsfråga, enkätdesign och analys.

## Examinationsformer

Kursen examineras genom övningar, seminarium samt hemtentamen.

## Arbetsformer

Arbetsformer är föreläsningar, seminarier, övningar i samtalsmetodik och ekonomisk biståndsbedömning, grupparbete samt statistiska övningar.
...
Som betygsskala används U–VG.
  ...
  - Övningar, seminarium, hemtentamen relaterat till försörjning, rehabilitering och aktivering, 4,5 hp, U - VG 
  - Övningar och hemtentamen relaterat till kvantitativ metod, 3 hp, U - G

## Förkunskapskrav

- Socialpolitikens betydelse för socialt arbete 7,5 hp och Välfärdsinsatser och brukarperspektiv 15 hp

## Övrigt

Kursplanen ingår i Socionomprogrammet. Kursen motsvarar SA1047.
...
- The Importance of Social Policy for Social Work 7.5 credits and Welfare Measures and User Perspectives 15 credits

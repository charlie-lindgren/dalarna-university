...
course_name: "Coaching, Sports, Outdoor Life and Health Within Society"
...
> | --- | --- | --- |
> | Examinationsformer | Saknar punktlista | Examinationsformer skrivet som löpande text: Kursen examineras genom aktivt deltagande i seminarier och individuella skriftliga inlämningsuppgifter.… |
...
> | Övrigt | Saknar standardfras om pedagogiskt stöd | Saknar standardfras om pedagogiskt stöd: Kursen motsvarar IH1137.… |
<!-- analys:end -->
...
- **Fastställd:** Fastställd 2021-02-03 . Kursplanen gäller fr.o.m. 2021-02-03.
...
Som bakgrund till ämnet och det sammanhang som områdena idrott, fysisk aktivitet och hälsa befinner sig i relaterat till samhället, tar kursen avstamp i idrottens historia. Kursen behandlar även medieutvecklingen med fokus på 1900-talet och framåt och relaterar till samhället, idrott, fysisk aktivitet och hälsa. Samhällsvetenskapliga teorier och synsätt belyses för att på ett djupare plan kunna diskutera idrott, hälsa och fysisk aktivitet lokalt, regionalt, nationellt och globalt.

## Examinationsformer

Kursen examineras genom aktivt deltagande i seminarier och individuella skriftliga inlämningsuppgifter.

## Arbetsformer

Arbetsformerna består av föreläsningar och obligatoriska seminarier.
...
Betygsrapportering:
  ...
  - Inlämningsuppgifter, 4,5 hp, U-VG

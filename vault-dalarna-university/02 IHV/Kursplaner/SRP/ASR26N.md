...
course_name: "Constructive Alignment of Curricula, Syllabi, Learning Activities and Examinations for Teachers in Higher Education"
hp: 15 högskolepoäng
niva: "Avancerad nivå"
...
> | --- | --- | --- |
> | Examinationsformer | Saknar punktlista | Examinationsformer skrivet som löpande text: Muntlig och skriftlig presentation via workshop.… |
...
> | Omfång på lärandemål | Långt mål | 30 ord: - diskutera vikten av samarbete och lagarbete inom och mellan utbildningsinstitu… |
...
Efter avslutad kurs ska den studerande kunna:
  ...
  - säkerställa progressionen från utbildningsplan och kursplaner på kandidatnivå till utbildningsplan och kursplaner på magisternivå i sexuell, reproduktiv och perinatal hälsa
  - utveckla utbildningsplan och kursplaner i barnmorskans ämnesområde med hjälp av konstruktiv länkning i skapandet av kursplaner och lärandemål med ett studentcentrerat lärande i fokus
  - analysera hur konstruktiv länkning används i varje läraktivitet och examination för att studenterna ska uppnå lärandemålen i en kursplan
  - utveckla läraktiviteter som är utmaningsdrivna och studentcentrerade för att uppnå utbildningsplanens och kursplanernas lärandemål med hjälp av nätbaserat lärande
  - kritiskt kvalitetsgranska digitala lärresurser, evidensbaserad litteratur och analysresurser för undervisning på avancerad nivå
  - kritiskt analysera de pedagogiska och tekniska utmaningarna med virtuella plattformar och digitala resurser för det pedagogiska arbetet inkluderande blandat nätbaserat lärande
  - säkerställa att jämlikhet, jämställdhet och hållbar utveckling enligt hållbarhetsmålen 2030 återspeglas i läroplan och kursplanernas mål
  - använda konstruktiv länkning, utmaningsdrivet, studentcentrerat lärande, digitala lärresurser
och olika examinationsmetoder
  - diskutera vikten av samarbete och lagarbete inom och mellan utbildningsinstitutioner och med kliniskt yrkesverksamma för att förbättra studentcentrerad högre utbildning samt kvinnors karriärutveckling och ledarskap inom utbildning och hälsosystem
  - reflektera över “planera-utföra-studera-agera-cykeln“ som en integrerad del av självvärdering och kvalitetsförbättring i varje kurs ur ett
studentcentrerat perspektiv
  - genomföra, analysera och presentera för- och eftermätning av den aktuella kursen.

## Innehåll

Kursen innehåller fördjupning i utveckling,
implementering och utvärdering av utbildningsplaner och kurser inom högre utbildning och lärande på magisternivå inom barnmorskans ämnesområde. Kursen leder till en fördjupad förståelse för globala och nationella perspektiv som influerar högre utbildning, vilket inkluderar samarbete
och teamarbete inom och mellan institutioner och kliniskt yrkesverksamma för
att stödja kvinnligt ledarskap samt värdera rättvisa och jämställdhet i vården
av kvinnor och barn. Vidare kommer pedagogiska och
digitala lärresurser användas i undervisningen både på campus och virtuellt.

## Examinationsformer

Muntlig och skriftlig presentation via workshop.
...
Betygsrapportering:
  ...
  - Muntliga och skriftliga presentationer, 15 hp

## Förkunskapskrav

- Kandidatexamen om minst 180 hp med huvudområde omvårdnad, folkhälsovetenskap

...
course_name: "Health Care and Social Care for People with Dementia (freestanding course)"
...
Föreläsningar, obligatoriska seminarier och individuella uppgifter som syftar till att studenten aktivt skall söka kunskap genom diskussion och kritiskt förhållningssätt enskilt och i grupp.
...
Kursen är helt nätbaserad och inga fysiska träffa på campus förekommer.

Denna kurs motsvarar kursen _Vård och omsorg för personer med demens_, 7,5 hp på avancerad nivå, och kan inte användas i en examen samtidigt som denna.

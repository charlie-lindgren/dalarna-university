...
url: https://www.du.se/sv/utbildning/kurser/kursplan/?code=AMC243
...
> | --- | --- | --- |
> | Examinationsformer | Saknar punktlista | Examinationsformer skrivet som löpande text: Examination sker genom skriftlig salstentamen, skriftliga uppgifter samt aktivt deltagande vid seminarier och metodövnin… |
> | Frasningskonsistens | Avviker från referensformen | Efter avslutad kurs ska den studerande kunna:… |
> | Omfång på lärandemål | Långt mål | 26 ord: - självständigt söka, sammanställa och kritiskt granska evidensbaserad informati… |
> | Samstämmighet svenska och engelska | Paritetsskillnad | Svenska: 9 mål, engelska: 0 mål (diff 9) |
> | Stavfel och språkbruk | Felstavning | `metodövnin` (sv) |
> | Stavfel och språkbruk | Felstavning (en) | `naprapath` (en) |
> | Stavfel och språkbruk | Felstavning (en) | `physiotherpy` (en) |
> | Övrigt | Saknar standardfras om pedagogiskt stöd | Saknar standardfras om pedagogiskt stöd: Kursen ingår som valbar kurs i Magisterprogram i fysioterapi. Kursen motsvarar MC3023.… |
<!-- analys:end -->

# AMC243

[Kursplan på du.se →](https://www.du.se/sv/utbildning/kurser/kursplan/?code=AMC243)

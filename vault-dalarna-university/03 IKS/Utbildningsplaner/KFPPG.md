...
- **Programkod:** KFPPG
- **Programansvarig:** Axel Grigor Göran Thorén
...
Under det första årets programspecifika kurser (som enbart ges för detta program) utforskas grundläggande verktyg, rutiner och principer för filmproduktioners kollektiva arbetsprocess genom teambaserade gestaltningsövningar. Förståelse för hur filmproduktioners kvaliteter påverkas av val som rör iscensättning, regi, ljud, foto, filmklippning, visuella effekter och färgbearbetning utvecklas. Detta sker genom ett undersökande förhållningssätt i produktion och efterbearbetning av en manusbaserad kortfilm, samt i filmhistoriska teorimoment.   
Under andra årets programgemensamma kurser undersöks relationen mellan samhälle och medier samt entreprenörskap och projekthantering inom medieproduktion. I dessa kurser studeras också projektutveckling och finansieringsformer för medieproduktion. Dessa kunskaper tillämpas i projektbaserade kurser som inkluderar externa beställare och medproducenter. Här ska beställares behov gällande format, genre och målgrupp vägas mot etiska och praktiska hänsyn. I dessa kurser utvecklas även en förståelse för olika audiovisuella plattformar, produktionsförutsättningar och uttrycksformer inom medieproduktion och dess aktuella strukturer och aktörer. Därutöver problematiseras mediers demokratiska funktion i samhället, inklusive en fördjupning i de juridiska och etiska ramverk som reglerar mediers verksamhet i Sverige. Utifrån dimensionerna ekologisk, ekonomisk och social hållbarhet introduceras hållbar medieproduktion.  
Under det andra läsåret fördjupas praktisk förståelse för filmklippningens centrala roll i filmberättandet. Dokumentärfilmens historia, uttrycksformer och arbetsprocesser undersöks i samband med produktion av en kort dokumentärfilm. Hur utvecklingen inom generativ AI och virtuell produktion påverkar arbetssätt, hållbarhetsmål och produktionsprocesser inom filmproduktion utforskas. För den som vill genomföra utbytesstudier vid ett annat lärosäte, förslagsvis internationellt, rekommenderas termin fyra för detta.  
...
- [[GMN3DZ|Grunder i filmproduktion]], 15 hp
- [[GMN3DY|Introduktion till medieproduktion]], 15 hp
- [[GMN3GY|Postproduktion]], 15hp
...
- [[GMN3EF|Filmklippning]], 7,5 hp
- [[GLP2BQ|Medieproduktion som projektarbete]], 15 hp
- [[GMN3EE|Medier och samhälle]], 7,5 hp
- [[GMN3EQ|Professionella filmproduktionsprocesser]], 7,5 hp

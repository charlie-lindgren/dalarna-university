...
scrape_hash: 103cad8aa0200fcd
url: https://www.du.se/sv/utbildning/kurser/kursplan/?code=GFÖ2RL
up: "[[Företagsekonomi]]"
---

# GFÖ2RL

[Kursplan på du.se →](https://www.du.se/sv/utbildning/kurser/kursplan/?code=GFÖ2RL)
...
- **Fastställd:** Fastställd 2021-09-10 . Kursplanen gäller fr.o.m. 2021-09-15.
...
Efter avslutad kurs ska studenten kunna:
  ...
  - diskutera organisationers verksamhet utifrån organisationsområdets teoretiska grund
  - redogöra för grundläggande begrepp, modeller och teoretiska grunder för ämnesområdet organisation 
  - redogöra för grundläggande vetenskapsteoretiska begrepp och deras koppling till det företagsekonomiska fältet
  - söka och samla relevant information och kritiskt värdera olika informationskällor för en mindre studie 
  - tillämpa regler för akademiskt skrivande med avseende på formalia och struktur
  - ta ställning till etiska frågeställningar kopplat till det företagsekonomiska området
...
Inom området organisation behandlas grundläggande organisationsteoretiska begrepp, modeller och teoretiska grunder. Organisationsteorins framväxt presenteras i sitt historiska sammanhang med speciell tonvikt på de perspektiv på organisation och ledarskap som är en följd av det sena 1900-talets forskning och debatt. Även organisationernas samspel med och beroendeförhållanden till samhället behandlas.

## Examinationsformer

Modul 1: Individuell skriftlig tentamen, 5 hp  
Modul 2: Skriftlig inlämningsuppgift i grupp med opposition och aktivt deltagande vid seminarium, 2,5 hp

## Arbetsformer

Föreläsningar och seminarier varav ett obligatoriskt.

## Betyg

Som betygsskala används U–VG.

För betyget Väl Godkänd på kursen krävs betyget Väl Godkänd på modul 1.

Betygsrapportering:  
Modul 1: Individuell skriftlig tentamen - 5 hp (U-VG)  
Modul 2: Skriftlig inlämningsuppgift i grupp med opposition och aktivt deltagande vid seminarium - 2,5 hp (U-G)
...
Kan ej tillgodoräknas i examen tillsammans med andra kurser med 
motsvarande innehåll, t.ex. Organisation A, 7,5 hp och Organisation och Marknadsföring 
A ,15 hp (Modulen Organisation A).   
Ersätter GFÖ2B8.

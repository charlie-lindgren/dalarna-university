---
kurskod: GFÖ2PJ
kursnamn: "Ekonomistyrning A"
course_name: "Financial Management A"
...
scrape_hash: 1a2a306e0b7dabe4
url: https://www.du.se/sv/utbildning/kurser/kursplan/?code=GFÖ2PJ
up: "[[Företagsekonomi MOC]]"
---

# GFÖ2PJ

[Kursplan på du.se →](https://www.du.se/sv/utbildning/kurser/kursplan/?code=GFÖ2PJ)

**Kursnamn:** Ekonomistyrning A
**Course Name:** Financial Management A

- **Poäng:** 7,5 högskolepoäng
- **Nivå:** Grundnivå
- **Kursen kan ingå i följande huvudområde(n):** Företagsekonomi 1
- **Ämnestillhörighet:** Företagsekonomi (FÖA)
- **Fastställd:** Fastställd 2021-04-13 . Kursplanen gäller fr.o.m. 2021-06-30.
...
För godkänt betyg på kursen krävs betyget Godkänd på samtliga delmoment. För betyget Väl godkänd krävs därutöver betyget Väl Godkänd på den skriftlig tentamen.
...
Upon completion of the course the student should be able to:  
  ...
  - Describe basic concepts and models within the area of management accounting with an emphazise on product and investment calculations and budgeting

Skills and abilities  
Upon completion of the course the student should be able to:  

  - Prepare cost and investment calculations and make analyses for performance planning 

  - Select appropriate management accounting approaches for various operations

Judgement and approach  
Upon completion of the course the student should be able to:  

  - Critically discuss and reflect upon ethical aspects and the role of management accounting in society

### Course Content

This course presents fundamental management accounting concepts with a focus on calculations, budgeting and performance planning. Also included are methods for planning and controlling of operations in practice.
...
To pass the course students must obtain the grade G on all assignments. To pass the course with distinction (VG), VG is in addition required on the written examination.

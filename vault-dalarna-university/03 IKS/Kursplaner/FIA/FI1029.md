...
url: https://www.du.se/sv/utbildning/kurser/kursplan/?code=FI1029
up: "[[Filosofi]]"
---
...
> | Introfras | Prosa/rubrik före frasning | Lärandemål inleds inte med 'Efter ...': **Kursens mål är att den studerande efter genomgången kurs ska:**… |
> | Omfång på lärandemål | För många mål | 10 lärandemål (maximum rekommenderat: 8 för 7.5 hp) |
> | Omfång på lärandemål | Långt mål | 28 ord: - på ett grundläggande sätt reflektera över och tillämpa centrala problemställni… |
> | Samstämmighet svenska och engelska | Paritetsskillnad | Svenska: 10 mål, engelska: 0 mål (diff 10) |
> | Stavfel och språkbruk | Felstavning | `problemställni` (sv) |
> | Övrigt | Saknar standardfras om pedagogiskt stöd | Saknar standardfras om pedagogiskt stöd: Kursen kan tillgodoräknas i Filosofi I. Denna kursplan ersätter FI1003.… |
<!-- analys:end -->

# FI1029

[Kursplan på du.se →](https://www.du.se/sv/utbildning/kurser/kursplan/?code=FI1029)

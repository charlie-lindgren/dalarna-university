...
cssclasses: [vilande]
scrape_hash: d15ae5088c7d56a4
url: https://www.du.se/sv/utbildning/kurser/kursplan/?code=AS4003
...
> | --- | --- | --- |
> | Betygsrapportering | Saknar punktlista | Betyg skrivet utan punktlista: Som betygsskala används A–F. Betygsrapportering:… |
> | Bloom-taxonomi | Låg verbnivå för avancerad kurs | Avancerad kurs utan analysera/värdera/skapa-verb; fördelning [3,0,0,0,0,0] |
> | Examinationsformer | Saknar punktlista | Examinationsformer skrivet som löpande text: Examination sker genom inlämning av skriftliga PM och muntliga redovisningar.… |
> | Frasningskonsistens | Avviker från referensformen | Efter avslutad kurs ska den studerande kunna:… |
> | Omfång på lärandemål | För få mål | 3 lärandemål (minimum rekommenderat: 5 för 16 hp) |
> | Övrigt | Sektion saknas | Ingen Övrigt-sektion i kursplanen |
<!-- analys:end -->

# AS4003

[Kursplan på du.se →](https://www.du.se/sv/utbildning/kurser/kursplan/?code=AS4003)

...
url: https://www.du.se/sv/utbildning/kurser/kursplan/?code=ANA235
up: "[[Nationalekonomi]]"
---
...
> | --- | --- | --- |
> | Betygsrapportering | Saknar punktlista | Betyg skrivet utan punktlista: Som betygsskala används U–VG. Inlämningsuppgifter U-G. Den skriftliga tentamen styr slutbetyget på kursen.… |
> | Examinationsformer | Saknar punktlista | Examinationsformer skrivet som löpande text: Examination sker i form av inlämningsuppgifter med seminarier (3 hp) samt skriftlig tentamen (4,5 hp).… |
> | Introfras | Prosa/rubrik före frasning | Lärandemål inleds inte med 'Efter ...': Studenterna skall efter genomgången kurs kunna:… |
> | Omfång på lärandemål | För många mål | 9 lärandemål (maximum rekommenderat: 8 för 7.5 hp) |
> | Omfång på lärandemål | Långt mål | 28 ord: - förklara hur möjligheten till att kunna para ihop olika aktörer med varandra, … |
> | Övrigt | Saknar standardfras om pedagogiskt stöd | Saknar standardfras om pedagogiskt stöd: Ersätter NA3009.… |
<!-- analys:end -->

# ANA235

[Kursplan på du.se →](https://www.du.se/sv/utbildning/kurser/kursplan/?code=ANA235)

...
url: https://www.du.se/sv/utbildning/kurser/kursplan/?code=NA1027
up: "[[Nationalekonomi]]"
---
...
> | Examinationsformer | Saknar punktlista | Examinationsformer skrivet som löpande text: Skriftlig examiniation.… |
> | Introfras | Prosa/rubrik före frasning | Lärandemål inleds inte med 'Efter ...': Kursen ger en introduktion till grundläggande ekonomiska teorier om världsekonomin. Syftet är att studenten efter genomg… |
> | Omfång på lärandemål | För många mål | 10 lärandemål (maximum rekommenderat: 8 för 7.5 hp) |
> | Samstämmighet svenska och engelska | Paritetsskillnad | Svenska: 10 mål, engelska: 11 mål (diff 1) |
...
[Kursplan på du.se →](https://www.du.se/sv/utbildning/kurser/kursplan/?code=NA1027)

...
> | Stavfel och språkbruk | Felstavning | `\btobbit\b` → Tobit |
> | Stavfel och språkbruk | Felstavning (en) | `tobbit` (en) |
> | Övrigt | Saknar standardfras om pedagogiskt stöd | Saknar standardfras om pedagogiskt stöd: Maximalt fem tentamenstillfällen. Ersätter NA3002.… |
<!-- analys:end -->

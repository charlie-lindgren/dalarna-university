...
url: https://www.du.se/sv/utbildning/kurser/kursplan/?code=NA1032
up: "[[Nationalekonomi]]"
---
...
> | Examinationsformer | Saknar punktlista | Examinationsformer skrivet som löpande text: Kursens mål (**1-6**) examineras via en skriftlig salstentamen motsvarande 6 hp (U-VG) och en dugga motsvarande 1,5 hp (… |
> | Introfras | Prosa/rubrik före frasning | Lärandemål inleds inte med 'Efter ...': Det övergripande målet med kursen är att studenterna ska tillägna sig kunskaper om olika makroekonomiska frågeställninga… |
> | Stavfel och språkbruk | Felstavning | `frågeställninga` (sv) |
> | Stavfel och språkbruk | Felstavning (en) | `descirbe` (en) |
> | Övrigt | Saknar standardfras om pedagogiskt stöd | Saknar standardfras om pedagogiskt stöd: Maximalt antal tentamenstillfällen är fem.… |
<!-- analys:end -->

# NA1032

[Kursplan på du.se →](https://www.du.se/sv/utbildning/kurser/kursplan/?code=NA1032)
...
- **Reviderad:** Reviderad 2015-06-17 . Revideringen är giltig fr.o.m. 2015-06-17.

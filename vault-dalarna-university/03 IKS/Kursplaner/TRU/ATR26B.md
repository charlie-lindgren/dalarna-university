---
kurskod: ATR26B
kursnamn: "Mot en mer hållbar och robust turismnäring 2"
course_name: "Towards Sustainability and Resilience in Tourism and Hospitality 2"
...
> | --- | --- | --- |
> | Betygsrapportering | Saknar punktlista | Betyg skrivet utan punktlista: Som betygsskala används A–F. Seminarier, U-G.… |
...
[Kursplan på du.se →](https://www.du.se/sv/utbildning/kurser/kursplan/?code=ATR26B)

**Kursnamn:** Mot en mer hållbar och robust turismnäring 2
**Course Name:** Towards Sustainability and Resilience in Tourism and Hospitality 2

- **Poäng:** 7,5 högskolepoäng
- **Nivå:** Avancerad nivå
- **Kursen kan ingå i följande huvudområde(n):** Kulturgeografi 1 Turismvetenskap 2
- **Ämnestillhörighet:** Turismvetenskap (TRU)
- **Fastställd:** Fastställd 2020-10-15 . Kursplanen gäller fr.o.m. 2020-10-30.

## Lärandemål

Efter avslutad kurs ska studenten kunna:

  - Visa förståelse för relationen mellan kriser, resiliens och hållbarhet i besöksnäringen.

  - Beskriva olika sätt och platser inom vilka kriser kan uppstå med koppling till besöksnäringen.

  - Visa förståelse för de huvudsakliga säkerhets-och hållbarhetsutmaningarna som besöksnäringens aktörer inkl. samhälle, organisationer och individer kan ställas inför

  - Genomföra en djupgående analys av besöksnäringens komplexa system med fokus på mänskliga, teknologiska och organisatoriska faktorer.

  - Visa på förmågan att kunna reflektera över och beskriva följderna av en rad olika kriser i besöksnäringen.

  - Diskutera användbarheten av flertalet lämpliga modeller och verktyg för att skapa resiliens i besöksnäringen med fokus på framtida planering och hållbarhet.
...
Föreläsningar, audiovisuellt material, seminarier och workshops samt diskussionsforum.
...
- Mot en mer hållbar och robust turismnäring I, 7,5 hp avancerad nivå

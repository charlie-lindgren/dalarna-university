...
scrape_hash: 8e144d474dc280ad
url: https://www.du.se/sv/utbildning/kurser/kursplan/?code=PA2011
...
> | --- | --- | --- |
> | Betygsrapportering | Saknar punktlista | Betyg skrivet utan punktlista: Som betygsskala används U–VG. Seminarier med muntlig redovisning U-G. För kursbetyg VG krävs G på moment 1 och 2 samt VG… |
> | Examinationsformer | Saknar punktlista | Examinationsformer skrivet som löpande text: Obligatoriska seminarier med muntlig redovisning av en process genomförd på en arbetsplats, 1 hp (mål 2,3,5) Obligatoris… |
...
> | Introfras | Prosa/rubrik före frasning | Lärandemål inleds inte med 'Efter ...': Syftet med kursen är att den studerande ska tillägna sig djupare kunskaper och färdigheter som en personalvetare behöver… |
> | Samstämmighet svenska och engelska | Paritetsskillnad | Svenska: 7 mål, engelska: 0 mål (diff 7) |
> | Övrigt | Saknar standardfras om pedagogiskt stöd | Saknar standardfras om pedagogiskt stöd: Ersätter PA2006… |
<!-- analys:end -->

# PA2011

[Kursplan på du.se →](https://www.du.se/sv/utbildning/kurser/kursplan/?code=PA2011)

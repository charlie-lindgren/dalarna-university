...
url: https://www.du.se/sv/utbildning/kurser/kursplan/?code=IE2003
...
> | --- | --- | --- |
> | Betygsrapportering | Saknar punktlista | Betyg skrivet utan punktlista: Som betygsskala används U–VG. Betyget sätts individuellt.… |
> | Examinationsformer | Saknar punktlista | Examinationsformer skrivet som löpande text: Kursen examineras genom en helhetsbedömning av slutrapporten, insatser på seminarier i form av oppositionsarbete, presen… |
> | Introfras | Prosa/rubrik före frasning | Lärandemål inleds inte med 'Efter ...': De allmänna målen med examensarbetet är att ge kursdeltagarna möjligheter att utveckla sin förmåga att inom ämnet indust… |
> | Övrigt | Sektion saknas | Ingen Övrigt-sektion i kursplanen |
<!-- analys:end -->

# IE2003

[Kursplan på du.se →](https://www.du.se/sv/utbildning/kurser/kursplan/?code=IE2003)
...
- Lekvall, Per och Wahlbin Clas. (2007) _Information för marknadsföringsbeslut_ . 4 uppl. Studentlitteratur AB. (412 s). ISBN 9186460854 

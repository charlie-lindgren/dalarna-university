...
CORRECTIONS: dict[str, str] = {
    ...
    "vilarpå": "vilar på",
    # ── Vanliga återkommande stavfel (institutionsoberoende, förhandsifyllda) ──
    # Universella engelska felstavningar som kan dyka upp i vilken institutions
    # kursplan som helst. Ord vars korrekta form skiljer sig mellan svenska och
    # engelska (t.ex. "paralell" → parallel/parallell) är medvetet utelämnade,
    # eftersom uppslagningen inte vet vilket språk träffen kommer från.
    ...
    "untill": "until",
    "writen": "written",
    # Vanliga svenska särskrivnings-/felstavningsfall (entydiga)
    "seperat": "separat",
    "defenitivt": "definitivt",
    "framförallt": "framför allt",
    "iallafall": "i alla fall",
    "tillexempel": "till exempel",
}
